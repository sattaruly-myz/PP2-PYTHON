...
def right_triangle_points(p1, p2):
    """
    Вычисляет вершины прямоугольного треугольника.
    Прямой угол в точке p1 (точка начала).
    Катеты идут вертикально вниз и горизонтально вправо.
    Вершины: p1 (прямой угол), (p1.x, p2.y), (p2.x, p2.y).
    """
    x1, y1 = p1
    x2, y2 = p2
